...
- The trusted module path `github.com/sjunepark/baton/cmd/baton@v0.1.5` is
...
- Created the public `sjunepark/baton` GitHub repository, pushed `main`, and
  validated a fresh `go install github.com/sjunepark/baton/cmd/baton@v0.1.2`.
- Hardened generated GitHub Actions templates to install Baton into
  ...
  `actions/setup-go@v5`.
- Restored work-branch-prefix enforcement in Go PR policy parity and covered
