...
```sh
go install github.com/sjunepark/baton/cmd/baton@v0.3.0
```
...
<!-- x-release-please-start-version -->
```sh
baton init --apply --go-install github.com/sjunepark/baton/cmd/baton@v0.3.0
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```sh
baton init --apply --install-command 'go install github.com/sjunepark/baton/cmd/baton@v0.3.0'
```
<!-- x-release-please-end -->
